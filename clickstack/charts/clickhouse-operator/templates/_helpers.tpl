...
*/}}
{{- define "clickhouse-operator.clickhouseServiceName" -}}
{{- printf "%s-clickhouse" (include "clickhouse-operator.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- include "clickhouse-operator.fullname" . }}
{{- end }}
{{- end }}
